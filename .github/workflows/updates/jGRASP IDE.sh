...
version=$(wget --no-check-certificate -qO- https://spider.eng.auburn.edu/user-cgi/grasp/version7.pl | awk -F '[;:]' '{ print $3 } { if ($7) print $9 }' | tail -n 1 | sed 's;/dl4g/jgrasp/jgrasp;;g')
