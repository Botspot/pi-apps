...
version="$(wget -qO- --header="User-Agent: This download is a result of the Pi-Apps store. Please stop blocking us. Please contact us if you have any questions. https://github.com/Botspot/pi-apps/issues/new/choose" https://downloads.winlink.org/User%20Programs/ | sed 's/<br>/\n/g' | grep 'Winlink_Express_install' | sed 's/">.*//g ; s/.*="\///g' | sort -V | tail -1)"
