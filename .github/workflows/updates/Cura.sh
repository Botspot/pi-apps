...
armhf_url[0]="https://github.com/smartavionics/Cura/releases/download/${webVer[0]}/Cura-mb-master-armhf-${webVer[0]}.AppImage"
armhf_url[1]="https://github.com/unlimitedbacon/stl-thumb/releases/download/v${webVer[1]}/stl-thumb_${webVer[1]}_armhf.deb"
arm64_url[0]="https://github.com/smartavionics/Cura/releases/download/${webVer[0]}/Cura-mb-master-aarch64-${webVer[0]}.AppImage"
