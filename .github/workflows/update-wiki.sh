  ...
  for category in "${categories[@]}"; do
    ...
    for script in "${script_name[@]}"; do
      if [[ "${script_category[$iter]}" == "$category" ]] && [[ -e "$GITHUB_WORKSPACE/apps/$script" ]]; then
        ...
        echo "### <img src=\"https://github.com/Botspot/pi-apps/blob/master/apps/$script_url/icon-64.png?raw=true\" height=32> ***[$script](https://github.com/Botspot/pi-apps/tree/master/apps/$script_url)***"
